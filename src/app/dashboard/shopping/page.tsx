...
export default function ShoppingListPage() {
  ...
  return (
    <div className="grid h-full grid-cols-[21.25rem_260px_1fr] gap-4">
      <div className="border-r">
        <h2 className="text-center text-xl capitalize">bookmark Recipes</h2>
        <BookmarksList detailLink="/dashboard/shopping" />
      </div>
      <div className="h-full border-r ">
        <h2 className="text-center text-xl capitalize">Ingridient list</h2>
        <div className="h-[calc(100vh-250px)] overflow-x-hidden p-4 flex flex-col gap-4 overflow-y-auto [&_.IngredientCard]:w-56 [&_.IngredientCard]:p-2 [&_.IngredientImage]:h-12 [&_.IngredientImage]:w-12 [&_h2]:mb-4 [&_h2]:text-[18px] [&_h4]:text-sm [&_p]:text-sm">
