...
function RecipeShortDetails() {
  ...
  return (
    ...
    <div className="absolute z-40 -ml-4 hidden h-[calc(100vh-70px)] flex-col justify-between bg-natural-cream md:relative md:z-0 md:ml-0 md:flex md:h-[calc(100vh-80px)]">
