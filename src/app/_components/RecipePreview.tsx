...
export default function RecipePreview({ review }: props) {
  return (
    <div className="border-1 dark:border-1 relative grid min-h-96 overflow-hidden rounded-md border-natural-terracotta bg-natural-beige dark:border-accent dark:bg-primary/25">
