    ...
    <div className="inline-flex items-center">
      <label className="relative flex cursor-pointer items-center">
        <input
          ...
          checked={checked}
          type="checkbox"
          className="peer h-5 w-5 cursor-pointer appearance-none rounded border border-slate-800 dark:border-slate-300 shadow transition-all checked:border-slate-800 checked:bg-accent hover:shadow-md"
          id="check"
        />
